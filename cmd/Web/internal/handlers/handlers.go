...
import (
	...
	"bookings/cmd/web/internal/dbrepo"
	"bookings/cmd/web/internal/driver"
	"bookings/cmd/web/internal/forms"
	"bookings/cmd/web/internal/helpers"
	"bookings/cmd/web/internal/models"
	"bookings/cmd/web/internal/render"
...
func (m *Repository) PostReservation(w http.ResponseWriter, r *http.Request) {
	...
	// send notification - reservation to guest
